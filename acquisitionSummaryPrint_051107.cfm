<!--- This page saves the data that was sent from acquisitionSummary.cfm into
tblAcqSummary, and then displays it in a printable format --->
...
<!--- query for saving the data sent by acquisitionSummary.cfm --->
<CFQUERY NAME="qryUpdateAcqSummary" DATASOURCE="#request.ds#">
	UPDATE	tblAcqSummary
	SET		strLocation = '#Form.location#',
			strDescription = '#Form.description#',
			strLegal = '#Form.legal#',
			strRollNumber = '#Form.rollNumber#',
			strCustodian = '#Form.custodian#',
			strPropertyUse = '#Form.propertyUse#',
			strInterestAcquired = '#Form.interestAcquired#',
			strAcquiredFrom = '#Form.acquiredFrom#',
			strPurchasePrice = '#Form.purchasePrice#',
			strAppraisedValue = '#Form.appraisedValue#',
			strAcquisitionDate = '#Form.completionDate#',
			strAgent = '#Form.agent#',
...
<table width="640" cellpadding="5" cellspacing="0" border="0" align="center">
	...
	<tr>
		<td colspan="2" align="center"><hr><h2>Summary of Property Acquisition</h2><hr><br></td>
	</tr>
<CFOUTPUT>
	<tr>
	...
	<tr>
		<td valign="top"><b>Use of Property:</b></td>
		<td>#Form.propertyUse#</td>
	</tr>
	<tr>
		<td valign="top"><b>Interest Acquired:</b></td>
		<td>#Form.interestAcquired#</td>
	</tr>
	<tr>
		<td valign="top"><b>Acquired From:</b></td>
		<td>#Form.acquiredFrom#</td>
	</tr>
	<tr>
		<td valign="top"><b>Purchase Price:</b></td>
		<td>#Form.purchasePrice#</td>
	</tr>
	<tr>
	...
	<tr>
		<td valign="top"><b>Date of Acquisition:</b></td>
		<td>#Form.completionDate#</td>
	</tr>
	<tr>
		<td valign="top"><b>Property Agent:</b></td>
		<td>#Form.agent#</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><br><br><br><br><img src="<CFIF browser EQ "MSIE">images/</CFIF>black.gif" width="350" height="<CFIF browser EQ "MSIE">1<CFELSE>2</CFIF>"><br><CFOUTPUT>#Form.agent#</CFOUTPUT>, Property Agent</td>
	</tr>
	<tr>
		<td colspan="2">
