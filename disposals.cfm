...
<CFIF IsDefined("URL.backup")>
	...
	<CFQUERY NAME="qryDisplayProject" DATASOURCE="#request.ds#">
		SELECT	tblProjects.intProjectID,
				...
				<!--- added this --->
				tblFactSheet.intPILTyear,
				tblFactSheet.strRemarks,
				tblFactSheet.intAssessmentYear,
	...
	<CFOUTPUT QUERY="qryDisplayProject">	
		...
		<CFLOCK SCOPE="SESSION" TYPE="EXCLUSIVE" TIMEOUT="15">
			...
			<CFSET Session.backupPILTyear = intPILTyear>
			<CFSET Session.backupRemarks = strRemarks>
			<CFSET Session.backupAssessmentYear = intAssessmentYear>
...
// where to redirect the user after it has saved the project.
	...
	if (document.layers) { // using Netscape
		...
		<!--- added this --->
		document.mainForm.assessmentYear.value = document.tab5.document.FactSheetForm.assessmentYear.value;
		document.mainForm.PILTyear.value = document.tab5.document.FactSheetForm.PILTyear.value;
		document.mainForm.remarks.value = document.tab5.document.FactSheetForm.remarks.value;
	...
	if (document.all) { // using IE
		...
		<!--- added this --->
		document.mainForm.assessmentYear.value = document.FactSheetForm.assessmentYear.value;
		document.mainForm.PILTyear.value = document.FactSheetForm.PILTyear.value;
		document.mainForm.remarks.value = document.FactSheetForm.remarks.value;
...
<FORM NAME="mainForm" ACTION="disposalSave.cfm" METHOD="POST">
	...
	<INPUT TYPE="hidden" NAME="year_integer"> <!--- what's this? --->
	<INPUT TYPE="hidden" NAME="PILT">
	
	<!--- added this --->
	<INPUT TYPE="hidden" NAME="assessmentYear">
	<INPUT TYPE="hidden" NAME="PILTyear">
...
<table border="0" cellpadding="4" cellspacing="0" width="600" align="center">
	...
	<tr bgcolor="#0099CC">
		...
		<!--- NEED TO CHANGE THE ADD NEW BUTTON--->
		<td wdith="90" align="center"><CFIF Client.LoggedIn EQ "Yes"><CFOUTPUT><a href="##" onClick="sendForm('appraisalUpdate.cfm?type=disposals&projectID=#tempProjectID#&add=yes'); return false;"><img src="images/button_add_status.gif" width="61" height="16" border="0"></a></CFOUTPUT></CFIF></td>
	</tr>
...
<CFOUTPUT QUERY="qryAppraisal">
	<tr <CFIF (currentrow MOD 2) NEQ 1>bgcolor="##D9F0FF"</CFIF>>
		...
		<td align="right" valign="top"><CFIF Client.LoggedIn EQ "Yes"><a href="##" onClick="sendForm('appraisalUpdate.cfm?type=disposals&projectID=#tempProjectID#&appraisalID=#intApprID#'); return false;"><img src="images/button_edit.gif" width="40" height="16" border="0"></a>&nbsp;<a onClick="return confirm('Are you sure you want to permanently delete this Appraisal?');" href="disposals.cfm?projectID=#URL.projectID#&appraisalDelete=#intApprID#&view=hq"><img src="images/button_delete.gif" width="44" height="16" border="0"></a></CFIF></td>
	</tr>
</CFOUTPUT>
</table>
<br><br>
...
<table>
	...
	<tr>
		...
		<td><INPUT TYPE="text" NAME="landAsses" id="txt_landAsses" SIZE=15 VALUE="<CFOUTPUT>#DollarFormat(tempLandAsses)#</CFOUTPUT>" onKeyUp="updateTotal();"></td>
	</tr>
	<tr>
		<td align="right">Building Assessment:</td>
		<td>
			<INPUT TYPE="text" NAME="buildingAsses" id="txt_buildingAsses" SIZE=15 VALUE="<CFOUTPUT>#DollarFormat(tempBuildingAsses)#</CFOUTPUT>" onKeyUp="updateTotal();">
			<span title="This is a calculated total of the Land and Building Assessments." style="cursor: help;">
				<img src="images/transparent.gif" border="0" width="20" height="1">Total: $<span id="lbl_totalAsses"></span>
			</span>
		</td>
	</tr>
	<tr> <!--- added this --->
		<td align="right">Assessment Year:</td>
		<td><INPUT TYPE="text" NAME="assessmentYear" SIZE=4 MAXLENGTH=4 VALUE="<CFOUTPUT>#tempAssessmentYear#</CFOUTPUT>"></td>
	</tr>
	<tr>
		...
		<!--- added this --->
		<td>Year:</td>
		<td><INPUT TYPE="text" NAME="PILTyear" SIZE=4 MAXLENGTH=4 VALUE="<CFOUTPUT>#tempPILTyear#</CFOUTPUT>"></td>
	</tr>
	...
	<tr>
		<td align="right">&nbsp;</td>
		<td><TEXTAREA NAME="remarks" ROWS=4 <CFIF browser EQ "MSIE">COLS=70<CFELSE>COLS=40</CFIF> WRAP="VIRTUAL"<CFIF browser EQ "MSIE"> style="font-size: 9pt; font-family: arial; color:#000000;"</CFIF>><CFOUTPUT>#tempRemarks#</CFOUTPUT></TEXTAREA></td>	
	</tr>
</table>
</FORM>
<script type="text/javascript">
function updateTotal() {
	var box1 = document.getElementById("txt_landAsses").value;
	var box2 = document.getElementById("txt_buildingAsses").value;
	var display = document.getElementById("lbl_totalAsses");
	
	var re_dollaramt = /^\$[0-9]*\.?[0-9]*$/;
	if((!re_dollaramt.test(box1)) || (!re_dollaramt.test(box2))) {
		total = "&nbsp;--";
	} else {
		box1 = (box1 != "$") ? parseFloat(box1.substring(1)) : 0;
		box2 = (box2 != "$") ? parseFloat(box2.substring(1)) : 0;
		var total = box1 + box2;
