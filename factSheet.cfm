...
<CFOUTPUT>
	...
	<tr>
		...
		<td>&nbsp;</td>
		<td>
			#DollarFormat(tempBuildingAsses)#
			<img src="images/transparent.gif" border="0" width="20" height="1">Total: #DollarFormat(tempLandAsses + tempBuildingAsses)#
		</td>
	</tr>
	<tr>
		<td align="right">Year:</td>
		<td>&nbsp;</td>
		<td>#tempAssessmentYear#</td>
	</tr>
	<tr>
	...
	<tr>
		<td align="right">PILT Year:</td>
		<td>&nbsp;</td>
		<td>#tempPILTyear#</td>
	</tr>
	<tr>
		<td colspan="3"><b><br>Remarks</b></td>
	</tr>
	<tr>
		<td colspan="2">&nbsp;</td>
		<td>#tempRemarks#</td>
