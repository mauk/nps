...
<CFIF #Client.Location# IS NOT 0 OR #Client.agent# IS NOT 0 OR #Client.department# IS NOT 0 OR #Client.projectType# IS NOT "all" OR #Client.clientContact# IS NOT 0>
