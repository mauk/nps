...
<table width="750" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td><FORM ACTION="projectList.cfm" METHOD="POST" NAME="searchForm">
        ...
        <table align="center" width="525" border="0" cellpadding="5" cellspacing="0">
          ...
          <!---[ap:locator:051107:u1]--->
          <tr>
            <td align="right"> Province/Territory: </td>
            <td><select name="province">
                <option value="all" selected="selected">All</option>
                <cfoutput query="qryProvince">
                  <option value="#intProvID#">#strProvNm#</option>
                </cfoutput>
              </select>
            </td>
          </tr>
          ...
          <tr>
            <td align="right"> PBMS Project Number: </td>
            <td><INPUT TYPE="text" NAME="projectNo" SIZE=10>
            </td>
          </tr>
		  <tr>
            <td align="right"> WBS Project Number (Fees): </td>
            <td><INPUT TYPE="text" NAME="websProjectNo" SIZE=10>
            </td>
          </tr>
          <tr>
            <td align="right"> File Number: </td>
            <td><INPUT TYPE="text" NAME="fileNo" SIZE=10>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td align="center" colspan=2><a href="#" onClick="document.searchForm.submit(); return false"><img src="images/button_submit.gif" width="65" height="25" border="0"></a>&nbsp; <a href="#" onClick="document.searchForm.reset(); return false;"><img src="images/button_reset.gif" width="61" height="25" border="0"></a> </td>
          </tr>
        </table>
      </form></td>
  </tr>
